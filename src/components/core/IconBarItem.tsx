...
export default function IconBarItem({ icon, isActive, onClick, tooltip }: Props) {
  ...
  return (
    <div className={classNames("w-full h-12 flex flex-row justify-center items-center py-6 px-2 border-r-4 hover:cursor-pointer group",
      ...
      <Tooltip2 content={tooltip} className={bpTheme} hoverOpenDelay={750} placement="right">
        <Icon
          className={classNames("hover:scale-110 !outline-none",
            ...
            { "text-neutral-500 dark:text-stone-500 group-hover:text-yellow-500": !isActive },)}
          icon={icon}
          size={24}
